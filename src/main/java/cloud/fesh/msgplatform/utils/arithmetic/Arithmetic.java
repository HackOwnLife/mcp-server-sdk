...
public class Arithmetic {
    ...
    public Arithmetic(String exp, int precision) {
        this.exp = exp;
        this.precision = precision;
        this.roundingMode = RoundingMode.HALF_UP;
        parse();
    ...
    public String calculate() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (isNumber(temp)) {
                ...
                BigDecimal tempNumber1 = getBigDecimal(numberStack.pop(), precision, roundingMode);

                BigDecimal tempNumber2 = getBigDecimal(numberStack.pop(), precision, roundingMode);
